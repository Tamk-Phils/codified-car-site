...
export const vehicleInput = z.object({
  ...
  mileage: z.string().max(80).nullable().optional(),
  transmission: z.string().max(80).nullable().optional(),
  exterior_color: z.string().max(80).nullable().optional(),
  interior_color: z.string().max(80).nullable().optional(),
  fuel_type: z.string().max(80).nullable().optional(),
  trim: z.string().max(120).nullable().optional(),
  title_status: z.string().max(80).nullable().optional(),
  body_type: z.string().max(80).nullable().optional(),
